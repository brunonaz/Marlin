...
#define STRING_CONFIG_H_AUTHOR "Bruno" // Who made the changes.
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.5   // Z offset: -below +above  [the nozzle] //medi manualmente abaixando o z ate o bico e depois ate desarmar o sensor.


// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 20 //20 Bruno erro igual o X_PROBE_OFFSET_FROM_EXTRUDER
